...
Welcome to the backend repository of EXPert - your go-to platform for effortless financial management. This repository contains all the backend code necessary to power the EXPert application.

<hr/>

## Getting Started

Follow these steps to set up the EXPert backend on your local machine:
...
- The development server will start running at http://localhost:3000, and you can access EXPert's backend routes from there.
