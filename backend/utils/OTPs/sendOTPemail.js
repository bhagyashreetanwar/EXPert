...
const sendOTPemail = asyncHandler(async ({ _id, email }, res) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Your EXPert Account Verification OTP",
    html: `
    <html>
      <head>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2>OTP Verification for EXPert Account</h2>
          </div>
          <div class="content">
            <p>Dear User,</p>
            <p>Your OTP for verifying your EXPert account is: <strong>${otp}</strong></p>
            <p>This OTP is valid for 1 minute. Please use it within this time period.</p>
            <p>If you did not request this OTP, please ignore this email.</p>
            <p>Thank you for choosing EXPert!</p>
          </div>
          <div class="footer">
